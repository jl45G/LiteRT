...
struct PadOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "Pad"; }
  DECL_TO_TFLITE;
};

struct PadV2Operation : public TfLiteOperation, virtual Operation {
...
struct SumOperation : public TfLiteOperation, virtual Operation {
...
struct Conv2DOperation : public TfLiteOperation, virtual Operation {
...
struct DepthwiseConv2DOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override {
...
struct CastOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "Cast"; }
  Type to;
  DECL_TO_TFLITE;
};

struct SelectV2Operation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "SelectV2"; }
  DECL_TO_TFLITE;
};

struct SliceOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "Slice"; }
  DECL_TO_TFLITE;
};

struct LessOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "Less"; }
  DECL_TO_TFLITE;
};

struct GreaterOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "Greater"; }
  DECL_TO_TFLITE;
};

struct MinimumOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "Minimum"; }
  DECL_TO_TFLITE;
};

struct MaximumOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "Maximum"; }
  DECL_TO_TFLITE;
};

struct LogicalAndOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "LogicalAnd"; }
  DECL_TO_TFLITE;
};

struct LogicalOrOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "LogicalOr"; }
  DECL_TO_TFLITE;
};

struct CosOperation : public TfLiteOperation, virtual Operation {
  absl::string_view GetName() const override { return "Cos"; }
  DECL_TO_TFLITE;
};

struct SinOperation : public TfLiteOperation, virtual Operation {
