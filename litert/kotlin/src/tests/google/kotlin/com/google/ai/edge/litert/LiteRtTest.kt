...
class LiteRtTest {
  ...
  fun tensorBufferRequirements() {
    ...
    input0Requirements.close()
    input1Requirements.close()
    outputRequirements.close()

    // TODO(b/410434259): why can't destroy tensor buffer requirements and compiled model?
    // compiledModel.close()
  }
