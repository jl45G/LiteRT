...
class Event internal constructor(internal val handle: Long) {
  ...
  companion object {
    ...
    private external fun nativeCreateFromSyncFenceFd(fd: Int, ownsFd: Boolean): Long

    private external fun nativeCreateFromOpenClEvent(clEventHandle: Long): Long

    private external fun nativeCreateManaged(eventType: Int): Long
  }
