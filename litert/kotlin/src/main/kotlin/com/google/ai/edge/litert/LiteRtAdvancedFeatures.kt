...
/**
 * Advanced features for LiteRT to support sync-fence based async execution
 * and zero-copy buffer operations.
 *
...
class LiteRtAdvancedFeatures {
  ...
  companion object {
    ...
    fun createEglSyncAndFenceFd(): Int {
      ...
      val eglSync = EGLExt.eglCreateSyncKHR(
        EGL14.eglGetCurrentDisplay(),
        EGLExt.EGL_SYNC_FENCE_KHR,
        null
      )
      ...
      try {
        ...
        val result = EGLExt.eglDupNativeFenceFDANDROID(
          EGL14.eglGetCurrentDisplay(),
          eglSync
        )
    ...
    /**
     * Fills an OpenGL buffer with test data using compute shaders.
     * This is equivalent to FillGlBuffer1/2 in the C++ tests.
     *
    ...
    fun fillGlBuffer(glId: Int, size: Int, divFactor: Float = 1.0f) {
      ...
      val shaderSource = """#version 310 es
    ...
    fun createAhwb(
      ...
      val usage = HardwareBuffer.USAGE_CPU_READ_RARELY or
