...
#include "tensorflow/lite/experimental/litert/c/litert_compiled_model_options.h"  // from @org_tensorflow
...
Java_com_google_ai_edge_litert_CompiledModel_nativeRunAsync(
    ...
    jlong compiled_model_handle, jlong model_handle,
    jint signature_index,
  ...
  auto result = compiled_model.RunAsync(
      ...
      input_buffer_vector, output_buffer_vector, /*OUT*/ async_executed);
