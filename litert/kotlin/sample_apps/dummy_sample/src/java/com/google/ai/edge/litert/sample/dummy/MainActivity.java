...
public class MainActivity extends AppCompatActivity {
  ...
  private void runScenarioWithAiPackModel() {
    ...
    try {
          ...
          new FutureCallback<CompiledModel>() {
            ...
            public void onSuccess(CompiledModel compiledModel) {
              try {
                ...
                logEvent("Failed to run inference", e);
              }
            }
      ...
      logEvent("Failed to get compiled model", e);
    }
  }
  ...
  private void runInference(CompiledModel compiledModel) throws LiteRtException {
  ...
  private CompiledModel simpleCpuGpuModel() throws LiteRtException {
  ...
  private CompiledModel simpleNpuModel() throws LiteRtException {
  ...
  @Nullable
  private ListenableFuture<CompiledModel> simpleAiPackModel() throws LiteRtException {
    NpuAcceleratorProvider npuAcceleratorProvider = new BuiltinNpuAcceleratorProvider(this);
    Environment env = Environment.create(npuAcceleratorProvider);
