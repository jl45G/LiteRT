...
class MainActivity : AppCompatActivity() {
  ...
  private val imageClassifier by lazy { Classifier(this, "FlowerModel.tflite", "labels.txt") }
  ...
  override fun onDestroy() {
    ...
    Log.i(TAG, "Before releasing classifier")
    imageClassifier.release()
    Log.i(TAG, "After releasing classifier")
  }
