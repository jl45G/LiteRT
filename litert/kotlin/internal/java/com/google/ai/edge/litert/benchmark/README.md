...
blaze build -c opt --android_platforms=//buildenv/platforms/android:arm64-v8a \
  third_party/odml/litert/litert/kotlin/internal/java/com/google/ai/edge/litert/benchmark \
  && adb install blaze-bin/third_party/odml/litert/litert/kotlin/internal/java/com/google/ai/edge/litert/benchmark/benchmark.apk
```
