...
# --- Configuration ---
ROOT_DIR="third_party/odml/litert/litert/"
...
HOST_NPU_LIBRARY_DIR="${BINARY_BUILD_PATH}/${PACKAGE_LOCATION}/async_segmentation.runfiles/google3/third_party/qairt/latest/lib/"
