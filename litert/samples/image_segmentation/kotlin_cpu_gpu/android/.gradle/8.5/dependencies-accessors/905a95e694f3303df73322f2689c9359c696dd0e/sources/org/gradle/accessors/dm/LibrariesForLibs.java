...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Returns the group of libraries at litert
     */
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'compose'.
            ...
            public Provider<MinimalExternalModuleDependency> getMaterial2() {
                return create("androidx.material2");
        }
    ...
    public static class LitertLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public LitertLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for litert (com.google.ai.edge.litert:litert)
         * with versionRef 'litert'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
        ...
        /**
         * Returns the group of libraries at litert.gpu
         */
    ...
    public static class LitertGpuLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public LitertGpuLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for gpu (com.google.ai.edge.litert:litert-gpu)
         * with versionRef 'litert'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
            ...
            /**
             * Creates a dependency provider for api (com.google.ai.edge.litert:litert-gpu-api)
         * with versionRef 'litert'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getApi() {
                return create("litert.gpu.api");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: litert (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: undercouchDownload (5.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for undercouchDownload to the plugin id 'de.undercouch.download'
             * with versionRef 'undercouchDownload'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getUndercouchDownload() { return createPlugin("undercouchDownload"); }
