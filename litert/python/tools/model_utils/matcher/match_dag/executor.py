...
from google3.third_party.odml.litert.litert.python.tools.model_utils.matcher.match_dag import instruction as inst
from google3.third_party.odml.litert.litert.python.tools.model_utils.matcher.match_dag import tblgen_def
