...
def main(_) -> None:
  ...
  @build_module_and_print(TY([2, 2], "f32"), TY([2], "f32"))
  ...
  @build_module_and_print(TY([1, 10, 10, 3], "f32"))
  ...
  @build_module_and_print(TY([1, 2, 3, 4], "f32"), TY([4, 10], "f32"))
  ...
  @build_module_and_print(TY([1, 2, 4, 3], "f32"), TY([4, 10], "f32"))
  ...
  @build_module_and_print(TY([1, 2, 3, 4], "f32"), TY([10, 4], "f32"))
  ...
  @build_module_and_print(TY([1, 2, 3, 4], "i32"))
  def bitcast_1(x):
  ...
  @build_module_and_print(TY([2, 2], "i32"), TY([2, 2], "i32"))
  ...
  @build_module_and_print(TY([4], "i32"), TY([2], "i32"))
  ...
  @build_module_and_print(TY([1, 2, 3, 4], "f32"))
  def cast_1(x):
    # CHECK-LABEL: cast_1
  ...
  @build_module_and_print(TY([1, 2, 2], "f32"), TY([1, 1, 1], "f32"))
  ...
  @build_module_and_print(TY([512], "i32"), TY([128, 256], "f32"))
  ...
  @build_module_and_print(TY([1, 4], "f32"))
  def gather_nd_1(x):
