...
from google3.third_party.odml.litert.litert.python.tools.model_utils import model_explorer_integration as me_integration
from google3.third_party.odml.litert.litert.python.tools.model_utils.dialect import func
