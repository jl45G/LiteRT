"""tfl.floor_mod operation definition."""
...
@core.register_mlir_transform("tfl.floor_mod")
@core.overload_cls_attrs
@irdl.irdl_op_definition
class FloorModOp(core.MlirOpBase):
  """Division reminder.
...
@_utils.op_builder_wraps(FloorModOp)
def floor_mod(*args, **kwargs):
  return FloorModOp(*args, **kwargs).output
