...
class CompiledModelApiTest(unittest.TestCase):
  ...
  @mock.patch('google3.third_party.odml.litert.litert.python.compiled_model_wrapper._pywrap_litert_compiled_model_wrapper.CreateCompiledModelFromFile')
  ...
  @mock.patch('google3.third_party.odml.litert.litert.python.compiled_model_wrapper._pywrap_litert_compiled_model_wrapper.CreateCompiledModelFromBuffer')
  ...
  def test_signature_methods_api(self):
    ...
    mock_model.GetSignatureIndex.assert_called_once_with("nonexistent_signature")
  ...
  def test_buffer_requirements_api(self):
    ...
    input_req = model.get_input_buffer_requirements(0, 0)
    mock_model.GetInputBufferRequirements.assert_called_once_with(0, 0)
    self.assertEqual(input_req, {
        "buffer_size": 16,
        "alignment": 64,
        "dtype": "float32"
    })
    ...
    output_req = model.get_output_buffer_requirements(0, 0)
    mock_model.GetOutputBufferRequirements.assert_called_once_with(0, 0)
    self.assertEqual(output_req, {
        "buffer_size": 16,
        "alignment": 64,
        "dtype": "float32"
    })

  @mock.patch('google3.third_party.odml.litert.litert.python.tensor_buffer_wrapper.tensor_buffer.TensorBuffer')
  def test_buffer_creation_api(self, mock_tensor_buffer_class):
    ...
    mock_model.CreateInputBuffers.return_value = [mock_input_capsule, mock_input_capsule]
    ...
    mock_model.CreateInputBufferByName.assert_called_once_with("serving_default", "input1")
    ...
    mock_model.CreateOutputBufferByName.assert_called_once_with("serving_default", "output")
  ...
  def test_run_methods_api(self):
    ...
    expected_input_map = {"input1": mock_buffer.capsule, "input2": mock_buffer.capsule}
