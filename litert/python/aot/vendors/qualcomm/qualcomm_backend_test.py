...
from google3.third_party.odml.litert.litert.python.aot.vendors.qualcomm import qualcomm_backend
from google3.third_party.odml.litert.litert.python.aot.vendors.qualcomm import target as target_lib
