...
from google3.third_party.odml.litert.litert.python.aot.vendors import fallback_backend
from google3.third_party.odml.litert.litert.python.aot.vendors.qualcomm import target as qnn_target
