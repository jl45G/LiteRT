...
load("//third_party/llvm/llvm-project/llvm:lit_test.bzl", "lit_test")
...
def model_utils_filecheck_tests(name, srcs, deps = [], **kwargs):
    ...
    for src in srcs:
        lit_test(
            name = src + ".test",
            driver = "//third_party/llvm/llvm-project/mlir:run_lit",
            srcs = [src],
            data = ["//third_party/llvm/llvm-project/mlir/test:lit_data", python],
