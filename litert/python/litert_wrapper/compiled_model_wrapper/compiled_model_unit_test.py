...
from google3.third_party.odml.litert.litert.python.litert_wrapper.compiled_model_wrapper.compiled_model import CompiledModel
from google3.third_party.odml.litert.litert.python.litert_wrapper.compiled_model_wrapper.hardware_accelerator import HardwareAccelerator
...
class CompiledModelApiTest(unittest.TestCase):
  ...
  @mock.patch(
      "google3.third_party.odml.litert.litert.python.litert_wrapper.compiled_model_wrapper._pywrap_litert_compiled_model_wrapper.CreateCompiledModelFromFile"
  )
  ...
  @mock.patch(
      "google3.third_party.odml.litert.litert.python.litert_wrapper.compiled_model_wrapper._pywrap_litert_compiled_model_wrapper.CreateCompiledModelFromBuffer"
  )
  ...
  @mock.patch(
      "google3.third_party.odml.litert.litert.python.litert_wrapper.tensor_buffer_wrapper.tensor_buffer.TensorBuffer"
  )
